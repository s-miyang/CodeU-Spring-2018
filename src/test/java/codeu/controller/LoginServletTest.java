...
public class LoginServletTest {
  ...
  // don't have to test for bad usernames because that's taken care of during registration

  @Test
  public void testDoPost_GoodPassword() throws IOException, ServletException {
    Mockito.when(mockRequest.getParameter("username")).thenReturn("test username");
